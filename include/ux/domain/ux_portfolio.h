...
typedef struct ux_pricer_s ux_pricer_t;

#define UX_PRICER_PUBLIC_FIELDS                                                \
  void (*free)(ux_pricer_t * pricer);                                          \
  double (*get_price)(ux_pricer_t * pricer, ux_position_t * position);         \
  double (*get_value)(ux_pricer_t * pricer, ux_position_t * position);
