...
typedef enum { UX_ORDER_SIDE_BUY, UX_ORDER_SIDE_SELL } ux_order_side;
...
ux_order_t *
ux_get_order_by_client_order_id(ux_ctx_t *ctx,
                                const char *id); /* client order id */
ux_order_t *
ux_get_order_by_provider_order_id(ux_ctx_t *ctx,
                                  const char *id); // provider order id
