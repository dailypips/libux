...
#define EVENT_FIELD(name, lname, destroy, clone, processor)	__ux_define__ UXE_##name##_FIELDS __CR__

EVENTDEF(EVENT_FIELD)
#undef EVENT_FIELD

#define EVENT_STRUCT(name, lname, destroy, clone, processor)	struct uxe_##lname##_s { __CR__ \
