...
void ux_strategy_manager_on_exception(ux_strategy_manager_t *manager,const char *source, ux_event_t *e, uxe_exception_t *exception);
...
void ux_strategy_manager_on_bid(ux_strategy_manager_t *manager,ux_instrument_t *instrument, uxe_bid_t *bid);
void ux_strategy_manager_on_ask(ux_strategy_manager_t *manager,ux_instrument_t *instrument, uxe_ask_t *ask);
void ux_strategy_manager_on_trade(ux_strategy_manager_t *manager,ux_instrument_t *instrument, uxe_trade_t *trade);
void ux_strategy_manager_on_level2_snapshot(ux_strategy_manager_t *manager,ux_instrument_t *instrument, uxe_level2_snapshot_t *snapshot);
void ux_strategy_manager_on_Level2_update(ux_strategy_manager_t *manager,ux_instrument_t *instrument, uxe_level2_update_t *update);
void ux_strategy_manager_on_bar_open(ux_strategy_manager_t *manager,ux_instrument_t *instrument, uxe_bar_t *bar);
void ux_strategy_manager_on_bar(ux_strategy_manager_t *manager,ux_instrument_t *instrument, uxe_bar_t *bar);
void ux_strategy_manager_on_bar_slice(ux_strategy_manager_t *manager,uxe_bar_slice_t *slice);
void ux_strategy_manager_on_news(ux_strategy_manager_t *manager,ux_instrument_t *instrument, uxe_news_t *news);
void ux_strategy_manager_on_fundamental(ux_strategy_manager_t *manager,ux_instrument_t *instrument, uxe_fundamental *fundamental);
void ux_strategy_manager_on_execution_report(ux_strategy_manager_t *manager,uxe_execution_report_t *report);
void ux_strategy_manager_on_account_report(ux_strategy_manager_t *manager,uxe_account_report_t *report);
