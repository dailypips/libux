...
void strategy_manager_register_market_data_request(
        ux_data_provider_t *provider, ux_instrument_t *instrument);

void strategy_manager_unregister_market_data_request(
        ux_data_provider_t *provider, ux_instrument_t *instrument);

void strategy_manager_start_strategy(ux_ctx_t *ctx,  ux_strategy_t *strategy,ux_strategy_mode mode)
{
...
ux_strategy_status_info_t *strategy_manager_get_status_info();
...
/*
void strategy_manager_on_parameter_changed(ux_ctx_t *ctx, Parameter oldParameter, Parameter newParameter);
void strategy_manager_on_property_changed(ux_ctx_t *ctx, OnPropertyChanged onPropertyChanged);
*/
