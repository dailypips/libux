...
void (*on_exception)(ux_strategy_t *strategy, const char *source, ux_event_t *e, ux_event_exception_t *exception);
...
void (*on_bid)(ux_strategy_t *strategy, ux_instrument_t *instrument, ux_event_bid_t *bid);
void (*on_ask)(ux_strategy_t *strategy, ux_instrument_t *instrument, ux_event_ask_t *ask);
void (*on_trade)(ux_strategy_t *strategy, ux_instrument_t *instrument, ux_event_trade_t *trade);
void (*on_level2_snapshot)(ux_strategy_t *strategy, ux_instrument_t *instrument, ux_event_l2snapshot_t *snapshot);
void (*on_Level2_update)(ux_strategy_t *strategy, ux_instrument_t *instrument, ux_event_l2update_t *update);
void (*on_bar_open)(ux_strategy_t *strategy, ux_instrument_t *instrument, ux_event_bar_t *bar);
void (*on_bar)(ux_strategy_t *strategy, ux_instrument_t *instrument, ux_event_bar_t *bar);
void (*on_bar_slice)(ux_strategy_t *strategy, ux_event_bar_slice_t *slice);
void (*on_news)(ux_strategy_t *strategy, ux_instrument_t *instrument, ux_event_news_t *news);
void (*on_fundamental)(ux_strategy_t *strategy, ux_instrument_t *instrument, ux_event_fundamental *fundamental);
void (*on_execution_report)(ux_strategy_t *strategy, ux_event_execution_report_t *report);
void (*on_account_report)(ux_strategy_t *strategy, ux_event_account_report_t *report);
